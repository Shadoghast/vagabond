/** @import {VagabondUser} from "../documents/user.mjs"; */
 ...
 * @param {VagabondUser} context.user
 * @param {Array<VagabondUser>} context.users List of users or userId who can see the roll, leave it empty if everyone can see.
