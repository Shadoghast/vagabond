...
export function renderCombatantConfig(app, html, context, options) {
  ...
  const dispositionInput = combatant.system.schema.getField("disposition").toFormGroup(
    {},
    {options: dispositions, value: combatant.system.disposition, blank: game.i18n.localize("VAGABOND.Combatant.base.FIELDS.disposition.blank"), dataset: {dtype: "Number"}}
  );
