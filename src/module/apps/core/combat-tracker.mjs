...
/**
 * A custom combat tracker that supports Vagabond's initiative system
 */
export default class VagabondCombatTracker extends foundry.applications.sidebar.tabs.CombatTracker {
  /** @override */
