...
export default class CharacterModel extends BaseActorModel {
  ...
  prepareDerivedData() {
    ...
    this.hero.primary.label = game.i18n.localize("VAGABOND.Actor.Character.FIELDS.hero.primary.value.label");
  ...
  async _onStartTurn(combatant) {
    ...
    if (characterClass && characterClass.system.turnGain) {
      ...
      await recoveryRoll.toMessage({
        speaker: VagabondChatMessage.getSpeaker({token: combatant.token}),
        flavor: game.i18n.localize("VAGABOND.Actor.Character.HeroicResourceGain")
      });
  ...
  get coreResource() {
    return {
      name: this.class?.system.primary ?? game.i18n.localize("VAGABOND.Actor.Character.FIELDS.hero.primary.value.label"),
      target: this.parent,
   ...
   * @returns {undefined | (Omit<VagabondItem, "type" | "system"> & { type: "ancestry", system: import("../item/ancestry.mjs").default})}
   */
  get ancestry() {
   ...
   * @returns {undefined | (Omit<VagabondItem, "type" | "system"> & { type: "career", system: import("../item/career.mjs").default})}
   */
  get career() {
   ...
   * @returns {undefined | (Omit<VagabondItem, "type" | "system"> & { type: "class", system: import("../item/class.mjs").default})}
   */
  get class() {
   ...
   * @returns {undefined | (Omit<VagabondItem, "type" | "system"> & { type: "culture", system: import("../item/culture.mjs").default})}
   */
  get culture() {
   ...
   * @returns {Array<Omit<VagabondItem, "type" | "system"> & { type: "kit", system: import("../item/kit.mjs").default }>}
   */
  get kits() {
