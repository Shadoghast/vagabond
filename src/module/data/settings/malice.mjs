import {VagabondNPCSheet} from "../../apps/_module.mjs";
import {systemID} from "../../constants.mjs";
/** @import {VagabondActor, VagabondCombat} from "../../documents/_module.mjs" */

const fields = foundry.data.fields;

/**
 * A data model to manage Malice in Vagabond
 */
export class MaliceModel extends foundry.abstract.DataModel {
  ...
  static label = "VAGABOND.Setting.Malice.Label";
  ...
  static hint = "VAGABOND.Setting.Malice.Hint";
  ...
  static onChange(value, options, userId) {
    for (const [index, app] of foundry.applications.instances) {
      if (app instanceof VagabondNPCSheet) {
   ...
   * @param {VagabondActor[]} heroes Heroes to tally up victories
   ...
   * @param {VagabondCombat} combat The active combat
   * @param {VagabondActor[]} heroes The heroes who are currently alive
   * @returns {Promise<MaliceModel>}
   */
