...
/** @import { VagabondActor } from "../actor.mjs" */
 ...
 * @param {VagabondItem} item          Item to which this advancement belongs.
...
export default class Advancement extends BaseAdvancement {
  ...
  static get metadata() {
    return {
      ...
      title: game.i18n.localize("VAGABOND.Advancement.Title"),
      hint: "",
      multiLevel: false,
      apps: {
  ...
  async createItemData(uuid, id) {
    ...
    return source.clone({
      ...
      "flags.vagabond.sourceId": uuid,
      "flags.vagabond.advancementOrigin": `${this.item.id}.${this.id}`
